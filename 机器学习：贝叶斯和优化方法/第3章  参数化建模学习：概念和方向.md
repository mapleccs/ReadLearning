...
![图3.1 拟合一个线性函数（a）和拟合一个二次函数（b）。灰线表示更优的拟合](C:\Users\Maple\AppData\Roaming\Typora\typora-user-images\image-20250509094657582.png)更一般，更形式化地，参数估计任务可以定义如下。给定一组数据点 $\left(y_n, \boldsymbol{x}_n\right), y_n \in$ $\mathbb{R}, \boldsymbol{x}_n \in \mathbb{R}^l, n=1,2, \cdots, N$ 和一个参数化 ${ }^{\ominus}$ 的函数集
$$
\begin{equation}
\label{qua3}
...
![图3.2 回归模型中输入－输出之间关系的框图](C:\Users\Maple\AppData\Roaming\Typora\typora-user-images\image-20250509112651369.png)
...
![图3.3 平方误差损失在点 $\boldsymbol{\theta}_*$ 处有唯一最小值](C:\Users\Maple\AppData\Roaming\Typora\typora-user-images\image-20250509133628992.png)
...
![image-20250509134012209](C:\Users\Maple\AppData\Roaming\Typora\typora-user-images\image-20250509134012209.png)
